...
class OrchestratorFastPathTests(unittest.TestCase):
    ...
    @patch("apps.assistant.orchestrator.run_python_analysis")
    @patch("apps.assistant.orchestrator.plan_execute")
    def test_orchestrator_can_run_team_points_delta_multi_call_route(
                ...
                "tables": [
                    {
                        ...
                        "columns": [
                            ...
                            {"id": "increase", "label": "Increase", "type": "number"},
                        ],
                        "rows": [
                            {
                                "team": "Magic",
        ...
        self.assertEqual(result.artifacts[2]["rows"][0]["team"], "Magic")
        ...
        self.assertEqual(analysis_request.operation.output_metric, "increase")
