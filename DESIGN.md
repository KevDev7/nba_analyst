...
version: alpha
name: NBA Analyst
description: A warm analytical workspace for an NBA analytics assistant. The system anchors on a tinted cream canvas with serif display headlines, deep court-green CTAs, dense readable tables, chart-first artifact cards, and dark product surfaces for debug/tool chrome. Brand voltage comes from the cream/court-green pairing — deliberately warm and humanist where most analytics products use cool blue + slate.

colors:
  primary: "#1F6B4E"
  primary-active: "#124332"
  primary-disabled: "#DDEADF"
  ink: "#141413"
  body: "#3d3d3a"
  body-strong: "#252523"
  muted: "#6c6a64"
