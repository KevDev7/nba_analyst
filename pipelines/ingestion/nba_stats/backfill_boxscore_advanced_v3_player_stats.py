"""
One-season historical backfill for nba_api BoxScoreAdvancedV3.PlayerStats.
...
# BoxScoreAdvancedV3 required range parameters for full-game results.
START_PERIOD = 0
END_PERIOD = 0
START_RANGE = 0
END_RANGE = 0
...
DESTINATION_PREFIX = "raw/boxscoreadvancedv3/playerstats"
...
def fetch_player_stats_for_game(game_id: str):
    """Fetch BoxScoreAdvancedV3.PlayerStats dataframe for one game."""
