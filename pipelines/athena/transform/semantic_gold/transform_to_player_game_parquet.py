...
def build_player_game_rows_from_tables(
    ...
    for row in player_table.to_pylist():
        ...
        candidate = {
            ...
            "player_position": to_str_or_none(row.get("position")),
            "player_status": to_str_or_none(row.get("status")),
            "player_order": to_int_or_none(row.get("order")),
            ...
            "plus_minus_points": to_int_or_none(row.get("plusMinusPoints")),
