...
PLAYER_GAME_SCHEMA = pa.schema(
    [
        ...
        pa.field("possessions", pa.float64()),
        ...
        pa.field("assist_to_turnover_ratio", pa.float64()),
        ...
        pa.field("steal_percentage", pa.float64()),
        pa.field("block_percentage", pa.float64()),
        pa.field("effective_field_goal_percentage", pa.float64()),
        pa.field("true_shooting_percentage", pa.float64()),
        pa.field("three_point_attempt_rate", pa.float64()),
        pa.field("free_throw_attempt_rate", pa.float64()),
    ]
)
...
PLAYER_SEASON_SCHEMA = pa.schema(
    [
        ...
        pa.field("personal_fouls_committed_per_game", pa.float64()),
        ...
        pa.field("field_goals_made_per_game", pa.float64()),
        pa.field("field_goals_attempted_total", pa.int64()),
        pa.field("field_goals_attempted_per_game", pa.float64()),
        pa.field("field_goals_percentage", pa.float64()),
        pa.field("two_pointers_made_total", pa.int64()),
        pa.field("two_pointers_made_per_game", pa.float64()),
        pa.field("two_pointers_attempted_total", pa.int64()),
        pa.field("two_pointers_attempted_per_game", pa.float64()),
        pa.field("two_pointers_percentage", pa.float64()),
        pa.field("three_pointers_made_total", pa.int64()),
        pa.field("three_pointers_made_per_game", pa.float64()),
        pa.field("three_pointers_attempted_total", pa.int64()),
        pa.field("three_pointers_attempted_per_game", pa.float64()),
        pa.field("three_pointers_percentage", pa.float64()),
        pa.field("free_throws_made_total", pa.int64()),
        pa.field("free_throws_made_per_game", pa.float64()),
        pa.field("free_throws_attempted_total", pa.int64()),
        pa.field("free_throws_attempted_per_game", pa.float64()),
        pa.field("free_throws_percentage", pa.float64()),
