    ...
    for game_id, rows in grouped.items():
        ...
        for row in rows:
            ...
            candidate = {
                ...
                "opponent_team_name": to_str_or_none(opponent.get("teamName")) if opponent is not None else None,
                "opponent_team_city": to_str_or_none(opponent.get("teamCity")) if opponent is not None else None,
                "opponent_team_abbreviation": to_str_or_none(opponent.get("teamTricode")) if opponent is not None else None,
                "score": score,
