"""
Register the silver player_game_opportunity_context parquet as an Athena external table.
"""
...
try:
    ...
    from pipelines.athena.transform.silver.build_silver_player_game_opportunity_context import (
        DESTINATION_KEY,
        S3_BUCKET,
        TABLE_NAME,
    )
    ...
    from pipelines.athena.transform.gold.athena_view_helpers import AthenaClient, load_settings
    from pipelines.athena.transform.silver.build_silver_player_game_opportunity_context import (  # type: ignore[no-redef]
        DESTINATION_KEY,
        S3_BUCKET,
        TABLE_NAME,
    )
...
ATHENA_DATA_KEY = "silver/player_game_opportunity_context/data.parquet"
TABLE_LOCATION = f"s3://{S3_BUCKET}/silver/player_game_opportunity_context/"
