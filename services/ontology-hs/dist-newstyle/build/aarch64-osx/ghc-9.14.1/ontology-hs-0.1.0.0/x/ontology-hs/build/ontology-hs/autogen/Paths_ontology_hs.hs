...
-- at runtime using the environment variable ontology_hs_bindir.
...
-- environment variable ontology_hs_libdir.
...
-- using the environment variable ontology_hs_dynlibdir.
...
-- runtime using the environment variable ontology_hs_datadir.
...
-- variable ontology_hs_libexedir.
...
-- using the environment variable ontology_hs_sysconfdir.
...
bindir     = "/Users/HungNguyen/.cabal/bin"
libdir     = "/Users/HungNguyen/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f/ontology-hs-0.1.0.0-inplace-ontology-hs"
dynlibdir  = "/Users/HungNguyen/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f"
datadir    = "/Users/HungNguyen/.cabal/share/aarch64-osx-ghc-9.14.1-ea4f/ontology-hs-0.1.0.0"
libexecdir = "/Users/HungNguyen/.cabal/libexec/aarch64-osx-ghc-9.14.1-ea4f/ontology-hs-0.1.0.0"
sysconfdir = "/Users/HungNguyen/.cabal/etc"

getBinDir     = catchIO (getEnv "ontology_hs_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "ontology_hs_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "ontology_hs_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ontology_hs_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ontology_hs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ontology_hs_sysconfdir") (\_ -> return sysconfdir)
